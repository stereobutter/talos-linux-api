...
class ApplyConfigurationRequest(betterproto.Message):
    ...
    on_reboot: bool = betterproto.bool_field(2)
    """replaced by mode"""
    ...
    def __post_init__(self) -> None:
        super().__post_init__()
        if self.is_set("on_reboot"):
            warnings.warn(
                "ApplyConfigurationRequest.on_reboot is deprecated", DeprecationWarning
            )
        if self.is_set("immediate"):
            warnings.warn(
                "ApplyConfigurationRequest.immediate is deprecated", DeprecationWarning
            )
